...
test_generator = UnchunkedGenerator_Seq1(cameras_valid, poses_valid, poses_valid_2d,
...
if args.render:
    ...
    gen = UnchunkedGenerator_Seq1(None, [ground_truth], [input_keypoints],
    ...
    def run_evaluation(actions, action_filter=None):
        ...
        for action_key in actions.keys():
            ...
            gen = UnchunkedGenerator_Seq1(cameras_act, poses_act, poses_2d_act,
                                     pad=pad, causal_shift=causal_shift, augment=args.test_time_augmentation,
